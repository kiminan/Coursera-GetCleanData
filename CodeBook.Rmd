---
title: "CodeBook For 'dataset2.csv'"
...
--------------| ----------------------------------------
tBodyAcc-mean()-X | The mean() of body acceleration measurements (X-axis) for this user-activity combination
fBodyAccMag-std() |  The mean() of body acceleration magnitude measurements for this user-activity combination
...              | ...  
***
#### License:
